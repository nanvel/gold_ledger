...
class CacheTable(Base):
    ...
    cache_products: Mapped[Decimal] = mapped_column(type_=sa.DECIMAL)
    cache_payments: Mapped[Decimal] = mapped_column(type_=sa.DECIMAL)
    cache_due_date: Mapped[datetime] = mapped_column(nullable=True)
    cache_to_pay: Mapped[Decimal] = mapped_column(type_=sa.DECIMAL)
