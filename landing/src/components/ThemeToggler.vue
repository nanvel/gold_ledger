<script setup>
import { Sun, Moon, Airplay } from 'lucide-vue-next'
...
<template>
  <div class="fixed bottom-5 end-5 z-10 flex flex-col items-center">
    <div class="dropdown dropdown-end dropdown-top">
      ...
      >
        <li class="text-base">
          <button data-set-theme="" data-act-class="active" @click="() => changeTheme('system')">
            <Airplay class="h-5" />
        ...
        <li>
          <button data-set-theme="dark" data-act-class="active" @click="() => changeTheme('dark')">
            <Moon class="h-5" />
