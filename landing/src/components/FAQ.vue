  ...
  <section class="py-8 lg:py-20" id="faq">
    <div class="container">
      <div class="text-center">
        ...
        <p class="mt-2 text-lg">Find solutions, tips, and more to enhance your SaaS experience.</p>
      </div>

      <div class="mt-12 flex justify-center gap-6">
        <div class="space-y-4 lg:w-1/2">
          <div class="collapse collapse-arrow border border-base-content/10">
            <input checked name="faq" type="radio" aria-label="open/close" />
            <div class="collapse-title text-xl font-medium">How does SaaS benefit my business?</div>
